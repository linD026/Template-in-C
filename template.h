...
#define template_function(type, name, parameter, content)                      \
  template_function_(type, name, parameter, content)
#define template_function_(type, name, parameter, content)                     \
  void t_##name_##type(type *arg, parameter) {                                 \
    typedef type T;                                                            \
    { content }                                                                \
  }
